...
type Batch interface {
	SubmitJob(ctx context.Context, jobID id.JobID, workflowsURL string, metadataURL string, projectID id.ProjectID, workspaceID accountdomain.WorkspaceID) (string, error)
