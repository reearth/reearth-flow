...
func (i *Asset) FindByWorkspace(ctx context.Context, tid accountdomain.WorkspaceID, keyword *string, sort *asset.SortType, p *usecasex.Pagination) ([]*asset.Asset, *usecasex.PageInfo, error) {
	return Run2(
		ctx, i.repos,
