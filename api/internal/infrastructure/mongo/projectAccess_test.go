...
func TestProjectAccess_FindByProjectID(t *testing.T) {
	...
	_, _ = c.Collection("projectAccess").InsertMany(ctx, []any{
		bson.M{"id": paid1.String(), "projelct": pid1.String(), "ispublic": true, "token": "token"},
		bson.M{"id": paid2.String(), "projelct": pid2.String(), "ispublic": true, "token": "token"},
	})
...
func TestProjectAccess_FindByToken(t *testing.T) {
	...
	_, _ = c.Collection("projectAccess").InsertMany(ctx, []any{
		bson.M{"id": paid1.String(), "projelct": pid1.String(), "ispublic": true, "token": "token1"},
		bson.M{"id": paid2.String(), "projelct": pid2.String(), "ispublic": true, "token": "token2"},
	})
...
func TestProjectAccess_Save(t *testing.T) {
	...
	_, _ = c.Collection("projectAccess").InsertOne(ctx, bson.M{"id": paid.String(), "projelct": pid.String(), "ispublic": true, "token": "token"})
