...
export const runs: Run[] = [
  {
    id: "12342q34safd",
    project: { id: "1234", name: "ABC Project", workflow: { id: "1234", name: "DEF Workflow" } },
    status: "running",
  ...
  {
    id: "asdf234asdfasdf2",
    project: { id: "1234", name: "ABC123 Project", workflow: { id: "1234", name: "DEF Workflow" } },
    status: "running",
    startedAt: "2024/04/26",
    logs: false,
    trigger: "api",
  },
  {
    ...
    project: {
      ...
      workflow: { id: "1234", name: "DEF Workflow" },
    },
    status: "running",
    startedAt: "2024/04/26",
    logs: false,
  ...
  {
    id: "4",
    project: { id: "1234", name: "ABdC Project", workflow: { id: "1234", name: "DEF Workflow" } },
    status: "queued",
    startedAt: "2024/04/26",
    logs: false,
    trigger: "api",
