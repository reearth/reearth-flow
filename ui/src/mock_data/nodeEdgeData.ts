...
export const initialNodes: Node[] = [
  {
    id: "1",
    type: "reader",
    data: { name: "Reader Node 1 asdf asdf", outputs: ["output1", "output2"], status: "success" },
    position: { x: 10, y: 1 },
  },
  {
    id: "1-transformer",
...
export const initialEdges: Edge[] = [
  ...
  { id: "e2t-5", source: "2-transformer", target: "5", data: { status: "idle" } },
  {
    id: "e6-2",
    source: "6",
    target: "2",
