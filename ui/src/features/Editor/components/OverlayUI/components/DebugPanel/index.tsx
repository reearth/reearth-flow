...
const DebugPanel: React.FC = () => {
  ...
  return debugJobId ? (
    <div
      className={`pointer-events-auto w-[95vw] overflow-hidden rounded-md bg-secondary shadow-md shadow-secondary transition-all ${minimized ? "h-[32px]" : expanded || hideTabularViewer ? "h-[80vh]" : "h-[500px]"}`}>
      <div
