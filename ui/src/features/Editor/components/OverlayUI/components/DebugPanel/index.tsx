...
const DebugPanel: React.FC = () => {
  ...
  return debugJobId ? (
    <div
      ...
      <Tabs
        className={`pointer-events-auto border border-border bg-secondary/70 p-1 shadow-md shadow-[black]/20 backdrop-blur  transition-all dark:border-primary dark:shadow-secondary ${minimized ? "h-[42px] w-[96vw] rounded-xl" : fullscreenDebug ? "h-[100vh] w-[100vw] rounded-none" : expanded ? "h-[65vh] w-[99vw] rounded-xl" : "h-[45vh] w-[96vw] rounded-xl"}`}
        value={tabValue}
