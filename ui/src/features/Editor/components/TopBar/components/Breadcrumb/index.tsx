  ...
  return (
    <div
      ...
      <div className="flex items-center gap-2">
        ...
        <p
          className={`max-w-[200px] truncate text-sm transition-all delay-0 duration-500 dark:font-light ${isHovered?.includes("project") ? "max-w-[50vw] delay-500 select-text" : undefined}`}
