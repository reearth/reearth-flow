...
const GetMeDocumentString = print(GetMeDocument);
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetMe(variables?: GetMeQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetMeQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetMeQuery>(GetMeDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetMe', 'query', variables);
    }
  };
}
