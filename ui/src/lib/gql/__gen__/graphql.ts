...
export type Job = Node & {
  ...
  deploymentId?: Maybe<Scalars['ID']['output']>;
  id: Scalars['ID']['output'];
...
export type RunProjectInput = {
  file: Scalars['Upload']['input'];
  parameters?: InputMaybe<Array<RunParameterInput>>;
...
export type ProjectFragment = { __typename?: 'Project', id: string, name: string, description: string, createdAt: any, updatedAt: any, workspaceId: string, sharedToken?: string | null, isLocked: boolean, deployment?: (
    { __typename?: 'Deployment' }
    & { ' $fragmentRefs'?: { 'DeploymentFragment': DeploymentFragment } }
...
export type TriggerFragment = { __typename?: 'Trigger', id: string, createdAt: any, updatedAt: any, lastTriggered?: any | null, workspaceId: string, deploymentId: string, eventSource: EventSourceType, authToken?: string | null, timeInterval?: TimeInterval | null, description: string, enabled: boolean, deployment: (
    ...
    { __typename?: 'Variable' }
    & { ' $fragmentRefs'?: { 'VariableFragment': VariableFragment } }
...
export type JobFragment = { __typename?: 'Job', id: string, workspaceId: string, status: JobStatus, startedAt: any, completedAt?: any | null, outputURLs?: Array<string> | null, userFacingLogsURL?: string | null, debug?: boolean | null, deployment?: { __typename?: 'Deployment', id: string, description: string } | null } & { ' $fragmentName'?: 'JobFragment' };
...
export type UserFacingLogFragment = { __typename?: 'UserFacingLog', jobId: string, timestamp: any, nodeId?: string | null, nodeName?: string | null, level: UserFacingLogLevel, message: string } & { ' $fragmentName'?: 'UserFacingLogFragment' };

export type CmsProjectFragment = { __typename?: 'CMSProject', id: string, name: string, alias: string, description?: string | null, license?: string | null, readme?: string | null, workspaceId: string, visibility: CmsVisibility, topics: Array<string>, starCount: number, createdAt: any, updatedAt: any } & { ' $fragmentName'?: 'CmsProjectFragment' };
...
export type GetWorkerConfigQuery = { __typename?: 'Query', workerConfig?: (
    { __typename?: 'WorkerConfig' }
    & { ' $fragmentRefs'?: { 'WorkerConfigFragment': WorkerConfigFragment } }
  ) | null };
...
export type UpdateWorkerConfigMutation = { __typename?: 'Mutation', updateWorkerConfig?: { __typename?: 'UpdateWorkerConfigPayload', config: (
      { __typename?: 'WorkerConfig' }
      & { ' $fragmentRefs'?: { 'WorkerConfigFragment': WorkerConfigFragment } }
    ) } | null };
...
export type GetWorkflowParametersQuery = { __typename?: 'Query', parameters: Array<(
    { __typename?: 'Parameter' }
...
export type CreateWorkflowVariableMutation = { __typename?: 'Mutation', declareParameter: (
    { __typename?: 'Parameter' }
    & { ' $fragmentRefs'?: { 'ParameterFragment': ParameterFragment } }
  ) };
...
export type UpdateWorkflowVariableMutation = { __typename?: 'Mutation', updateParameter: (
    { __typename?: 'Parameter' }
    & { ' $fragmentRefs'?: { 'ParameterFragment': ParameterFragment } }
  ) };
...
export type UpdateWorkflowVariablesMutation = { __typename?: 'Mutation', updateParameters: Array<(
    { __typename?: 'Parameter' }
    & { ' $fragmentRefs'?: { 'ParameterFragment': ParameterFragment } }
  )> };
