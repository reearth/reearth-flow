...
export type DeploymentFragment = { __typename?: 'Deployment', id: string, projectId: string, workspaceId: string, workflowId: string, version: string, createdAt: any, updatedAt: any } & { ' $fragmentName'?: 'DeploymentFragment' };
