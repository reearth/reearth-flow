...
export type ProjectFragment = { __typename?: 'Project', id: string, name: string, version: number, description: string, createdAt: any, updatedAt: any, workspaceId: string, sharedToken?: string | null, deployment?: (
    { __typename?: 'Deployment' }
    & { ' $fragmentRefs'?: { 'DeploymentFragment': DeploymentFragment } }
...
export type JobFragment = { __typename?: 'Job', id: string, workspaceId: string, status: JobStatus, startedAt: any, completedAt?: any | null, logsURL?: string | null, outputURLs?: Array<string> | null, deployment?: { __typename?: 'Deployment', id: string, description: string } | null } & { ' $fragmentName'?: 'JobFragment' };
