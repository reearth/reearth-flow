...
export type ProjectFragment = { __typename?: 'Project', id: string, name: string, description: string, createdAt: any, updatedAt: any, workspaceId: string, sharedUrl?: string | null, deployment?: (
    { __typename?: 'Deployment' }
    & { ' $fragmentRefs'?: { 'DeploymentFragment': DeploymentFragment } }
...
export type GetWorkspaceByIdQuery = { __typename?: 'Query', node?: { __typename: 'Asset' } | { __typename: 'Deployment' } | { __typename: 'Document' } | { __typename: 'Job' } | { __typename: 'Project' } | { __typename: 'Trigger' } | { __typename: 'User' } | (
    { __typename: 'Workspace' }
    & { ' $fragmentRefs'?: { 'WorkspaceFragment': WorkspaceFragment } }
  ) | null };
