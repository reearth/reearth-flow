...
export type UserFacingLogFragment = { __typename?: 'UserFacingLog', jobId: string, timestamp: any, message: string, metadata?: any | null } & { ' $fragmentName'?: 'UserFacingLogFragment' };
