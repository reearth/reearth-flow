...
export type DeploymentFragment = { __typename?: 'Deployment', id: string, projectId: string, workspaceId: string, workflowUrl: string, version: string, createdAt: any, updatedAt: any } & { ' $fragmentName'?: 'DeploymentFragment' };
