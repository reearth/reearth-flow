...
const GeneralNode: React.FC<GeneralNodeProps> = ({
  ...
  return (
    <div
      className={`max-w-[200px] min-w-[150px] rounded-lg border bg-secondary p-1 shadow-md shadow-[black]/10 backdrop-blur-xs dark:shadow-secondary ${selected ? selectedColor : borderColor} ${data.isDisabled ? "opacity-70" : ""}`}>
