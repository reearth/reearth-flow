...
const GeneralNode: React.FC<GeneralNodeProps> = ({
  ...
  return (
    <div
      className={`max-w-[200px] min-w-[150px] rounded-lg border p-1 shadow-md shadow-secondary backdrop-blur-xs dark:bg-secondary  ${selected ? selectedColor : borderColor} ${data.isDisabled ? "opacity-70" : ""}`}>
