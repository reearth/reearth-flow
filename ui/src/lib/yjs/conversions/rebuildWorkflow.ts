...
export const reassembleNode = (yNode: YNode): Node => {
  ...
  if ((yNode.get("data") as Y.Map<any>)?.get("metadata") !== undefined) {
    data.metadata = (yNode.get("data") as Y.Map<any>)?.get("metadata");
  }
  ...
  if ((yNode.get("data") as Y.Map<any>)?.get("paramsSchema") !== undefined) {
    data.paramsSchema = (yNode.get("data") as Y.Map<any>)?.get("paramsSchema");
  }
