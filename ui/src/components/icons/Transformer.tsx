...
const TransformerIcon: React.FC<{ className?: string; id?: string; style?: CSSProperties }> = ({
  className,
  id,
  style,
}) => (
  <svg
    ...
    <g>
      <g>
        <path
          d="M325.662,3.768C324.325,1.437,321.844,0,319.157,0H164.555c-3.218,0-6.078,2.053-7.107,5.102L91.19,201.421
