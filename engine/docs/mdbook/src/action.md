...
```json
{
  ...
  "definitions": {
    ...
    "TextureCodec": {
      "title": "Texture Codec",
      "description": "Texture image codec for the writer's atlas pages.",
      "oneOf": [
        {
...
```json
{
  ...
  "properties": {
    "outsideCoverage": {
      ...
      "description": "What to do with a JGD2011 feature that has a vertex outside the coverage of the height revision parameters (`jgd2024ToWgs84` only). Defaults to `passThrough`.",
      "anyOf": [
        {
