...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "GeoPackageReader Parameters",
  "description": "Configuration for reading GeoPackage files (.gpkg). GeoPackage is an SQLite-based standard for geospatial data supporting: - Vector features (points, lines, polygons) - Raster tiles - Attributes and metadata - Spatial indexes",
  "type": "object",
  "properties": {
    "attributeFilter": {
      "title": "Attribute Filter",
      "description": "Optional SQL WHERE clause to filter features by attributes",
      "type": [
        "string",
        "null"
      ]
    ...
    "batchSize": {
      "title": "Batch Size",
      "description": "Number of features to process in each batch (for memory efficiency)",
      "default": 1000,
      "type": "integer",
      "format": "uint",
      "minimum": 0.0
    ...
    "force2d": {
      "title": "Force 2D",
      "description": "If true, forces all geometries to be 2D (ignoring Z and M values)",
      "default": false,
      "type": "boolean"
    },
    "includeMetadata": {
      "title": "Include Metadata",
      "description": "If true, includes GeoPackage metadata tables in the output",
      "default": false,
      "type": "boolean"
    },
    "inline": {
    ...
    "layerName": {
      "title": "Layer Name",
      "description": "Specific layer to read from the GeoPackage. If not specified, reads all feature layers.",
      "type": [
        "string",
        "null"
      ]
    ...
    "readMode": {
      "title": "Read Mode",
      "description": "What type of data to read from the GeoPackage",
      "default": "features",
      "allOf": [
        {
    ...
    "spatialFilter": {
      ...
      "description": "Optional bounding box filter [minX, minY, maxX, maxY] in the layer's CRS",
      "type": [
        "array",
        "null"
      ],
  ...
  "definitions": {
    ...
    "GeoPackageReadMode": {
      "oneOf": [
        {
          "description": "Read vector features",
          "type": "string",
          "enum": [
            "features"
          ]
        ...
        {
          "description": "Read both features and tiles",
          "type": "string",
          "enum": [
            "all"
          ]
        ...
        {
          "description": "Read only metadata and layer information",
          "type": "string",
          "enum": [
            "metadataOnly"
          ]
