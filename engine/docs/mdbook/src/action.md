...
```json
{
  ...
  "properties": {
    "mergeFilterAttributes": {
      ...
      "description": "If true, copy all attributes from matched filter feature(s) onto the candidate. Only applies to features routed to the passed port.",
      "default": false,
      "type": "boolean"
    },
    "mergedAttributesPrefix": {
      "title": "Merged Attributes Prefix",
      "description": "Optional prefix applied to merged filter attribute names to avoid collisions.",
      "default": null,
      "type": [
        "string",
        "null"
