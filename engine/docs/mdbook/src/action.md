...
```json
{
  ...
  "properties": {
    "outsideCoverage": {
      ...
      "description": "What to do with a JGD2011 feature that has a vertex outside the coverage of both height revision parameter sets (`jgd2024ToWgs84` only). Defaults to `passThrough`.",
      "anyOf": [
        {
