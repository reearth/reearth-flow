...
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Model Georeferencer Parameters",
  "description": "Controls how model-space coordinates are oriented and positioned on the globe.",
  "type": "object",
  "required": [
    "placement"
  ],
  "properties": {
    "placement": {
      "title": "Placement",
      "description": "How the model is positioned on the globe.",
      "allOf": [
        {
  ...
  "definitions": {
    "Placement": {
      ...
      "oneOf": [
        {
          "title": "Declare CRS",
          "description": "Treats the coordinates as already being in the given coordinate reference system and tags them without moving them.",
          "type": "object",
          "required": [
            "epsgCode",
            "type"
          ...
          "properties": {
            ...
            "epsgCode": {
              "title": "EPSG Code",
              "description": "EPSG code the coordinates are already expressed in. Must use linear units, because model coordinates are distances rather than angles.",
              "type": "integer",
              "format": "uint16",
              "minimum": 0.0
            }
        ...
        {
          "title": "Anchor",
          "description": "Places a local model at a geographic position, aligning it to the local east/north/up directions there.",
          "type": "object",
          "required": [
            "latitude",
            "longitude",
          ...
          "properties": {
            ...
            "height": {
              "title": "Height",
              "description": "Height of the anchor in metres above the ellipsoid.",
              "default": null,
              "type": [
                "object",
                "null"
            ...
            "heading": {
              "title": "Heading",
              "description": "Rotation of the model about its vertical axis, in degrees clockwise from north.",
              "default": null,
              "type": [
                "object",
                "null"
