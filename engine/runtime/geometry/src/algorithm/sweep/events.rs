...
#[derive(Debug)]
pub(crate) struct Event<T: GeoNum, Z: GeoNum, P> {
    pub point: SweepPoint<T, Z>,
    pub ty: EventType,
    pub payload: P,
}
...
/// segment_key.
impl<T: GeoNum, Z: GeoNum, P> PartialEq for Event<T, Z, P> {
...
impl<T: GeoNum, Z: GeoNum, P> Eq for Event<T, Z, P> {}
...
impl<T: GeoNum, Z: GeoNum, P> PartialOrd for Event<T, Z, P> {
...
impl<T: GeoNum, Z: GeoNum, P> Ord for Event<T, Z, P> {
