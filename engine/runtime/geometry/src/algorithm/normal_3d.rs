...
pub fn compute_normal_3d(
    ...
    let result = if normalize {
        ...
        Coordinate3D::new__(normalized.x, normalized.y, normalized.z)
    } else {
        Coordinate3D::new__(normal.x, normal.y, normal.z)
    };
...
mod tests {
    ...
    fn test_compute_normal_3d_basic() {
        ...
        let a = Coordinate3D::new__(0.0, 0.0, 0.0);
        let b = Coordinate3D::new__(1.0, 0.0, 0.0);
        let c = Coordinate3D::new__(0.0, 1.0, 0.0);
    ...
    fn test_compute_normal_3d_without_normalization() {
        ...
        let a = Coordinate3D::new__(0.0, 0.0, 0.0);
        let b = Coordinate3D::new__(2.0, 0.0, 0.0);
        let c = Coordinate3D::new__(0.0, 2.0, 0.0);
    ...
    fn test_compute_normal_3d_arbitrary_plane() {
        ...
        let a = Coordinate3D::new__(1.0, 0.0, 0.0);
        let b = Coordinate3D::new__(0.0, 1.0, 0.0);
        let c = Coordinate3D::new__(0.0, 0.0, 1.0);
    ...
    fn test_compute_normal_3d_collinear_points() {
        ...
        let a = Coordinate3D::new__(0.0, 0.0, 0.0);
        let b = Coordinate3D::new__(1.0, 1.0, 1.0);
        let c = Coordinate3D::new__(2.0, 2.0, 2.0);
