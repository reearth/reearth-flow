//! Geometric predicates over polygon-mesh leaves.

use super::{PolygonMesh2D, PolygonMesh3D};
use crate::predicates::{self, Equal};

impl Equal for PolygonMesh2D {
...
impl Equal for PolygonMesh3D {
    fn equal(&self, _rhs: &Self, _tolerance: f64) -> predicates::Result<bool> {
        ...
        unimplemented!("geometric equality is not implemented for PolygonMesh3D")
    }
}
