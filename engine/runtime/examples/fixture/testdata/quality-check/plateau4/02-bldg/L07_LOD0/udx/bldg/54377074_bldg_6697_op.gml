					...
					<gml:surfaceMember>
						<gml:Polygon>
							<gml:exterior>
								<gml:LinearRing>
									<gml:posList>
                                        36.64773967207627 137.0537094956814 0

                                        <!-- TEST:
                                            経度の小数点以下8桁目が+1だけ違う点を足した
                                            Duplicate Consecutive Points
                                        -->
                                        36.64773967207627 137.0537095056814 0

                                        36.647798243275254 137.05370057460766 0
                                        36.64778832538864 137.053600937653 0
                                        36.64772975430324 137.053609970643 0
                                        36.64773967207627 137.0537094956814 0
                                    </gml:posList>
								</gml:LinearRing>
							</gml:exterior>
