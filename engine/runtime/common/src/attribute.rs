...
impl AttributeValue {
    ...
    pub fn extend(self, value: Self) -> crate::Result<Self> {
        match (self, value) {
            ...
            _ => Err(crate::Error::attribute("Cannot extend")),
        }
    }
...
impl TryFrom<f64> for AttributeValue {
    ...
    fn try_from(value: f64) -> Result<Self, Self::Error> {
        Number::from_f64(value)
            ...
            .ok_or_else(|| crate::Error::attribute("f64 value is NaN or infinite"))
    }
}
...
impl TryFrom<Uri> for AttributeValue {
    ...
    fn try_from(value: Uri) -> std::result::Result<Self, Self::Error> {
        let value: serde_json::Value =
            serde_json::to_value(value).map_err(crate::Error::attribute)?;
        Ok(value.into())
    }
}
