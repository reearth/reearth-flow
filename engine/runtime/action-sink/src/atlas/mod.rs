...
type PolygonUVs = Vec<[f64; 2]>;
type TextureUVs = Vec<PolygonUVs>;
...
pub(super) const MAX_ATLAS_SIZE: u32 = 8192;
pub(super) const MAX_DOWNSAMPLE_K: u32 = 13;
...
fn build_atlas(
    ...
    ext: &str,
) -> crate::errors::Result<Vec<Option<TextureUVs>>> {
    let mut k = 0;
