...
<core:CityModel xmlns:brid="http://www.opengis.net/citygml/bridge/2.0" xmlns:wtr="http://www.opengis.net/citygml/waterbody/2.0" xmlns:tran="http://www.opengis.net/citygml/transportation/2.0" xmlns:gml="http://www.opengis.net/gml" xmlns:frn="http://www.opengis.net/citygml/cityfurniture/2.0" xmlns:veg="http://www.opengis.net/citygml/vegetation/2.0" xmlns:sch="http://www.ascc.net/xml/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:tun="http://www.opengis.net/citygml/tunnel/2.0" xmlns:tex="http://www.opengis.net/citygml/texturedsurface/2.0" xmlns:app="http://www.opengis.net/citygml/appearance/2.0" xmlns:gen="http://www.opengis.net/citygml/generics/2.0" xmlns:dem="http://www.opengis.net/citygml/relief/2.0" xmlns:luse="http://www.opengis.net/citygml/landuse/2.0" xmlns:uro="https://www.geospatial.jp/iur/uro/3.1" xmlns:xAL="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:bldg="http://www.opengis.net/citygml/building/2.0" xmlns:smil20="http://www.w3.org/2001/SMIL20/" xmlns:pbase="http://www.opengis.net/citygml/profiles/base/2.0" xmlns:smil20lang="http://www.w3.org/2001/SMIL20/Language" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:core="http://www.opengis.net/citygml/2.0" xmlns:grp="http://www.opengis.net/citygml/cityobjectgroup/2.0" xsi:schemaLocation="https://www.geospatial.jp/iur/urf/3.1 ../../schemas/iur/urf/3.1/urbanFunction.xsd  https://www.geospatial.jp/iur/uro/3.1 ../../schemas/iur/uro/3.1/urbanObject.xsd  http://www.opengis.net/citygml/2.0 http://schemas.opengis.net/citygml/2.0/cityGMLBase.xsd http://www.opengis.net/citygml/landuse/2.0 http://schemas.opengis.net/citygml/landuse/2.0/landUse.xsd  http://www.opengis.net/citygml/building/2.0 http://schemas.opengis.net/citygml/building/2.0/building.xsd  http://www.opengis.net/citygml/transportation/2.0 http://schemas.opengis.net/citygml/transportation/2.0/transportation.xsd  http://www.opengis.net/citygml/generics/2.0 http://schemas.opengis.net/citygml/generics/2.0/generics.xsd  http://www.opengis.net/citygml/relief/2.0 http://schemas.opengis.net/citygml/relief/2.0/relief.xsd  http://www.opengis.net/citygml/cityobjectgroup/2.0 http://schemas.opengis.net/citygml/cityobjectgroup/2.0/cityObjectGroup.xsd  http://www.opengis.net/gml http://schemas.opengis.net/gml/3.1.1/base/gml.xsd http://www.opengis.net/citygml/appearance/2.0 http://schemas.opengis.net/citygml/appearance/2.0/appearance.xsd">
	...
	<!-- 無効な空間属性の型テスト（2フィーチャ） -->
	<!-- フィーチャ1: LOD2にMultiSurfaceを使用（LOD2はBRepSolid=gml:Solidであるべき） -->
	<!-- 管路表面のみ（端面なし＝非水密）でSolidに昇格されない開いたMultiSurface -->
	<core:cityObjectMember>
		<uro:SewerPipe gml:id="unf_test_invalid_geom_type_lod2">
			...
			<frn:lod2Geometry>
				<gml:MultiSurface srsName="http://www.opengis.net/def/crs/EPSG/0/10169" srsDimension="3">
					<!-- 上面パネル（2三角形） -->
					<gml:surfaceMember>
						<gml:Polygon gml:id="poly-lod2-ms-top-001">
							<gml:exterior>
								<gml:LinearRing>
									<gml:posList>157000.0 21600.0 110.2 157001.0 21601.0 110.2 157000.2 21600.0 110.2 157000.0 21600.0 110.2</gml:posList>
								</gml:LinearRing>
							</gml:exterior>
						</gml:Polygon>
					</gml:surfaceMember>
					<gml:surfaceMember>
						<gml:Polygon gml:id="poly-lod2-ms-top-002">
							<gml:exterior>
								<gml:LinearRing>
									<gml:posList>157000.2 21600.0 110.2 157001.0 21601.0 110.2 157001.2 21601.0 110.2 157000.2 21600.0 110.2</gml:posList>
								</gml:LinearRing>
							</gml:exterior>
						</gml:Polygon>
					</gml:surfaceMember>
					<!-- 底面パネル（2三角形） -->
					<gml:surfaceMember>
						<gml:Polygon gml:id="poly-lod2-ms-bottom-001">
							<gml:exterior>
								<gml:LinearRing>
									<gml:posList>157000.0 21600.0 109.8 157000.2 21600.0 109.8 157001.0 21601.0 109.8 157000.0 21600.0 109.8</gml:posList>
								</gml:LinearRing>
							</gml:exterior>
						</gml:Polygon>
					</gml:surfaceMember>
					<gml:surfaceMember>
						<gml:Polygon gml:id="poly-lod2-ms-bottom-002">
							<gml:exterior>
								<gml:LinearRing>
									<gml:posList>157000.2 21600.0 109.8 157001.2 21601.0 109.8 157001.0 21601.0 109.8 157000.2 21600.0 109.8</gml:posList>
								</gml:LinearRing>
							</gml:exterior>
						</gml:Polygon>
					</gml:surfaceMember>
					<!-- 左面パネル（2三角形） -->
					<gml:surfaceMember>
						<gml:Polygon gml:id="poly-lod2-ms-left-001">
							<gml:exterior>
								<gml:LinearRing>
									<gml:posList>157000.0 21600.0 109.8 157001.0 21601.0 109.8 157001.0 21601.0 110.2 157000.0 21600.0 109.8</gml:posList>
								</gml:LinearRing>
							</gml:exterior>
						</gml:Polygon>
					</gml:surfaceMember>
					<gml:surfaceMember>
						<gml:Polygon gml:id="poly-lod2-ms-left-002">
							<gml:exterior>
								<gml:LinearRing>
									<gml:posList>157000.0 21600.0 109.8 157001.0 21601.0 110.2 157000.0 21600.0 110.2 157000.0 21600.0 109.8</gml:posList>
								</gml:LinearRing>
							</gml:exterior>
						</gml:Polygon>
					</gml:surfaceMember>
					<!-- 右面パネル（2三角形） -->
					<gml:surfaceMember>
						<gml:Polygon gml:id="poly-lod2-ms-right-001">
							<gml:exterior>
								<gml:LinearRing>
									<gml:posList>157000.2 21600.0 109.8 157000.2 21600.0 110.2 157001.2 21601.0 110.2 157000.2 21600.0 109.8</gml:posList>
								</gml:LinearRing>
							</gml:exterior>
						</gml:Polygon>
					</gml:surfaceMember>
					<gml:surfaceMember>
						<gml:Polygon gml:id="poly-lod2-ms-right-002">
							<gml:exterior>
								<gml:LinearRing>
									<gml:posList>157000.2 21600.0 109.8 157001.2 21601.0 110.2 157001.2 21601.0 109.8 157000.2 21600.0 109.8</gml:posList>
								</gml:LinearRing>
							</gml:exterior>
						</gml:Polygon>
					</gml:surfaceMember>
	...
	<!-- フィーチャ2: LOD3にSolidを使用（LOD3はMultiSurface/CompositeSurfaceであるべき） -->
	<core:cityObjectMember>
		<uro:SewerPipe gml:id="unf_test_invalid_geom_type_lod3">
			<gml:name>汚水管路</gml:name>
			<core:creationDate>2025-03-21</core:creationDate>
			<frn:lod3Geometry>
				<gml:Solid srsName="http://www.opengis.net/def/crs/EPSG/0/10169" srsDimension="3">
					<gml:exterior>
						<gml:CompositeSurface>
							<gml:surfaceMember>
								<gml:Polygon gml:id="poly-lod3-solid-bottom-001">
									<gml:exterior>
										<gml:LinearRing>
							...
							<gml:surfaceMember>
								<gml:Polygon gml:id="poly-lod3-solid-top-001">
									<gml:exterior>
										<gml:LinearRing>
											<gml:posList>157000.0 21600.0 110.0 157001.0 21600.0 110.0 157001.0 21601.0 110.0 157000.0 21601.0 110.0 157000.0 21600.0 110.0</gml:posList>
										</gml:LinearRing>
									</gml:exterior>
								</gml:Polygon>
							</gml:surfaceMember>
							<gml:surfaceMember>
								<gml:Polygon gml:id="poly-lod3-solid-front-001">
									<gml:exterior>
										<gml:LinearRing>
							...
							<gml:surfaceMember>
								<gml:Polygon gml:id="poly-lod3-solid-back-001">
									<gml:exterior>
										<gml:LinearRing>
							...
							<gml:surfaceMember>
								<gml:Polygon gml:id="poly-lod3-solid-left-001">
									<gml:exterior>
										<gml:LinearRing>
							...
							<gml:surfaceMember>
								<gml:Polygon gml:id="poly-lod3-solid-right-001">
									<gml:exterior>
										<gml:LinearRing>
