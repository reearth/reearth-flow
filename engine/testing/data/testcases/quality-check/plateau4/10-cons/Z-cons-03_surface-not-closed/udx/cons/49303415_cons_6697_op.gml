...
<core:CityModel xmlns:app="http://www.opengis.net/citygml/appearance/2.0" xmlns:core="http://www.opengis.net/citygml/2.0" xmlns:gml="http://www.opengis.net/gml" xmlns:uro="https://www.geospatial.jp/iur/uro/3.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/citygml/2.0 http://schemas.opengis.net/citygml/2.0/cityGMLBase.xsd http://www.opengis.net/citygml/profiles/base/2.0 http://schemas.opengis.net/citygml/profiles/base/2.0/CityGML.xsd https://www.geospatial.jp/iur/uro/3.1 ../../schemas/iur/uro/3.1/urbanObject.xsd https://www.geospatial.jp/iur/urf/3.1 ../../schemas/iur/urf/3.1/urbanFunction.xsd">
  <gml:boundedBy>
    <gml:Envelope srsName="http://www.opengis.net/def/crs/EPSG/0/6697" srsDimension="3">
      <gml:lowerCorner>32.92947556288802 130.56506892376652 2.8725533090642776</gml:lowerCorner>
      <gml:upperCorner>32.92948188978779 130.56507647174683 3.8725579834128867</gml:upperCorner>
    </gml:Envelope>
  </gml:boundedBy>
  <!-- ===================================================================== -->
  <!-- LOD3面のエラー: Non-Planar Surface (非平面性エラー)                    -->
  <!-- PlanarityFilter (threshold: 0.01m) で検出される                       -->
  <!-- RoofSurface内の四角形ポリゴンで、4番目の頂点のZ値をずらして非平面にする -->
  <!-- ===================================================================== -->
              ...
              <gml:surfaceMember>
                <gml:CompositeSurface gml:id="poly_2b4e38f9-85c0-48c9-a2d0-9a1ed928bead">
                  <gml:surfaceMember>
                    ...
                    <!-- 正常な平面: z = 3.3725579834128867 だが、4番目の頂点を z = 3.8725579834128867 にずらす -->
                    <!-- ずれ量 0.5m >> threshold 0.01m なので確実に検出される -->
                    <gml:Polygon gml:id="fme-gen-796179f6-762b-43b8-b48e-6c7240c72187">
                      <gml:exterior>
                        <gml:LinearRing>
                          <gml:posList>32.929478700529216 130.56507647174683 3.3725579834128867 32.92948188978779 130.56507311335878 3.3725579834128867 32.929478752146466 130.56506892376652 3.3725579834128867 32.929475562888015 130.56507228215463 3.8725579834128867 32.929478700529216 130.56507647174683 3.3725579834128867</gml:posList>
                        </gml:LinearRing>
                      </gml:exterior>
                    </gml:Polygon>
                  </gml:surfaceMember>
