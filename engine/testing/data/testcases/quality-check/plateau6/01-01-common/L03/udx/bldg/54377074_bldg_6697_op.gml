...
">
	...
	<core:cityObjectMember>
		<!-- TEST: a veg:PlantCover placed under the bldg package. bldg accepts only
		     Building / CityObjectGroup, so this is an L03 invalid-feature-type error.
		     No codeSpace attribute is attached so the codeSpace check (L04) stays clean. -->
