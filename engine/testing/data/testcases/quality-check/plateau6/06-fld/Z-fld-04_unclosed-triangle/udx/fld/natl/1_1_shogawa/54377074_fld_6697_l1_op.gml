...
<!--
  Unclosed ring fixture for plateau6 06-fld, CityGML 3.0 + i-UR 4.0.

  One wtr:WaterBody holding a single triangle whose last coordinate misses the
  first by 11 cm:

      A  (36.647100,  137.052800)
      B  (36.647100,  137.052830)
      C  (36.647130,  137.052830)
      A' (36.647101,  137.052800)   11 cm north of A

  Four coordinates, so the corner count is right; the gap is far larger than the
  1 cm at which two corners count as one, so A and A' are not taken for the same
  point either. The ring simply never closes. Read as (easting, northing) it
  still winds counter-clockwise, so the winding check passes.

  A ring that does not close bounds no face, so the error location layer marks
  it with a point rather than an outline.
-->
...
https://www.geospatial.jp/iur/urc/4.0 ../../../../schemas/iur/urc/4.0/urbanCore.xsd">
	...
	<core:cityObjectMember>
		<wtr:WaterBody gml:id="fld_e08b4276-3ca9-41d5-97e2-6b35108fd7a4">
			...
			<core:boundary>
				<wtr:WaterSurface gml:id="wtrs_a6f3d90b-27e4-4851-bc06-9d4e2af71538">
					<core:lod1MultiSurface>
						<gml:MultiSurface srsName="http://www.opengis.net/def/crs/EPSG/0/6697" srsDimension="3">
							<gml:surfaceMember>
								<gml:Polygon gml:id="poly_0c8a5e14-b6d7-4f29-a350-e7182c6b4903">
									<gml:exterior>
										<gml:LinearRing>
											<gml:posList>36.647100 137.052800 0 36.647100 137.052830 0 36.647130 137.052830 0 36.647101 137.052800 0</gml:posList>
										</gml:LinearRing>
									</gml:exterior>
								</gml:Polygon>
							</gml:surfaceMember>
