...
<!--
  No-error reference data for plateau6 03-tran (CityGML 3.0 + i-UR 4.0).
  A single valid tran:Road whose LOD1 surface is held by tran:TrafficArea under tran:TrafficSpace.
  Coordinates are within saitama-shi mesh 53395499 (simplified from the PLATEAU5 saitama source data).
-->
...
urn:oasis:names:tc:ciq:xal:3 ../../schemas/citygml/xAL/3.0/xAL.xsd">
	...
	<core:cityObjectMember>
		<tran:Road gml:id="tran_422a4508-0e87-427a-a3db-a5f1e5de84c0">
			...
			<tran:section>
				<tran:Section gml:id="tran_3a2fbca7-c3ad-4207-ac4f-ff6a00897c6c">
					<tran:trafficSpace>
