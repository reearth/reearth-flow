...
<!--
  ...
  A single tran:Track within saitama-shi mesh 53395499 (EPSG:6697) carrying two boundaries,
...
urn:oasis:names:tc:ciq:xal:3 ../../schemas/citygml/xAL/3.0/xAL.xsd">
	...
	<core:cityObjectMember>
		<tran:Track gml:id="trk_5e2b8c41-7a09-4d63-8f15-2c4e6a8b0d37">
			...
			<tran:section>
				<tran:Section gml:id="trk_b3a48d02-3368-4e81-91ae-84d4fb18891a">
					<tran:trafficSpace>
						<tran:TrafficSpace gml:id="trk_6f3c9d52-8b1a-4e74-9026-3d5f7b9c1e48">
							<core:boundary>
								<tran:TrafficArea gml:id="trk_7a4d0e63-9c2b-4f85-8137-4e6a8c0d2f59">
					...
					<tran:auxiliaryTrafficSpace>
						<tran:AuxiliaryTrafficSpace gml:id="trk_9c6f2a85-1e4d-4a07-8359-7c0e2b4d6f81">
							<core:boundary>
								<tran:AuxiliaryTrafficArea gml:id="trk_0d7a3b96-2f5e-4b18-946a-8d1f3c5e7a92">
