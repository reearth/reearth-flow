...
<!--
  ...
  L-tran-02 detects, per LOD and package, 2D footprint overlaps between DIFFERENT tran:Track instances.

  Placed under udx/trk so the result files carry the 03-3_徒歩道 prefix; otherwise identical to the
  tran:Road fixture next to it.

  Four tran:Track features within saitama-shi mesh 53395499 (EPSG:6697):
    - Track 1 and Track 2 carry LOD3 TrafficArea rectangles that share a collinear edge AND overlap in
      area (same latitude band, partially overlapping longitude range). They are the expected error pair.
    - Track 3 and Track 4 carry LOD1 TrafficArea rectangles that share only a single edge (zero overlap
...
urn:oasis:names:tc:ciq:xal:3 ../../schemas/citygml/xAL/3.0/xAL.xsd">
	...
	<core:cityObjectMember>
		<!-- Track 1: LOD3 rectangle, overlaps Track 2 in area with a collinear shared edge -> reported. -->
		<tran:Track gml:id="trk_2f8e1c0a-3b6d-4e21-9c14-5a7b9d0e1f23">
			<gml:name>11100-trk-1</gml:name>
			...
			<tran:section>
				<tran:Section gml:id="trk_851c2747-262f-49d0-8855-a9502c8094e6">
					<tran:trafficSpace>
						<tran:TrafficSpace gml:id="trk_7d3a9b21-6c48-4f15-8e92-1a4b7c0d3e56">
							<core:boundary>
								<tran:TrafficArea gml:id="trk_b6e04c19-2f7a-4d83-9b51-6c8e0a2f4d17">
	...
	<core:cityObjectMember>
		<!-- Track 2: LOD3 rectangle, overlaps Track 1 in area with a collinear shared edge -> reported. -->
		<tran:Track gml:id="trk_3a9f2d1b-4c7e-4f32-8d25-6b8c0e1f2a34">
			<gml:name>11100-trk-2</gml:name>
			<core:creationDate>2025-03-21T00:00:00</core:creationDate>
			<core:adeOfAbstractCityObject>
				<urc:DataQualityAttribute>
					<urc:geometrySrcDescLod1 codeSpace="../../codelists/DataQualityAttribute_geometrySrcDesc.xml">000</urc:geometrySrcDescLod1>
			...
			<tran:section>
				<tran:Section gml:id="trk_504fa514-f26d-4fd6-9ba9-1bbd6c220e79">
					<tran:trafficSpace>
						<tran:TrafficSpace gml:id="trk_8e4b0c32-7d59-4a26-9f83-2b5c8d1e4f67">
							<core:boundary>
								<tran:TrafficArea gml:id="trk_c7f15d2a-3e8b-4c94-8a62-7d9f0b3e5a18">
									<core:lod3MultiSurface>
	...
	<core:cityObjectMember>
		<!-- Track 3: LOD1 rectangle, shares only one edge with Track 4 (zero overlap area) -> not reported. -->
		<tran:Track gml:id="trk_4b0a3e2c-5d8f-4a43-9e36-7c9d1f2a3b45">
			<gml:name>11100-trk-3</gml:name>
			<core:creationDate>2025-03-21T00:00:00</core:creationDate>
			<core:adeOfAbstractCityObject>
				<urc:DataQualityAttribute>
					<urc:geometrySrcDescLod1 codeSpace="../../codelists/DataQualityAttribute_geometrySrcDesc.xml">000</urc:geometrySrcDescLod1>
			...
			<tran:section>
				<tran:Section gml:id="trk_668506ca-7963-4351-b80e-cd742a2819b5">
					<tran:trafficSpace>
						<tran:TrafficSpace gml:id="trk_9f5c1d43-8e60-4b37-8a94-3c6d9e2f5a78">
							<core:boundary>
								<tran:TrafficArea gml:id="trk_d8025e3b-4f9c-4da5-9b73-8e0a1c4f6b29">
	...
	<core:cityObjectMember>
		<!-- Track 4: LOD1 rectangle, shares only one edge with Track 3 (zero overlap area) -> not reported. -->
		<tran:Track gml:id="trk_5c1b4f3d-6e90-4b54-8f47-8d0e2a3b4c56">
			<gml:name>11100-trk-4</gml:name>
			<core:creationDate>2025-03-21T00:00:00</core:creationDate>
			<core:adeOfAbstractCityObject>
				<urc:DataQualityAttribute>
					<urc:geometrySrcDescLod1 codeSpace="../../codelists/DataQualityAttribute_geometrySrcDesc.xml">000</urc:geometrySrcDescLod1>
			...
			<tran:section>
				<tran:Section gml:id="trk_77900a37-4534-42c6-ad05-2ddfdde698f4">
					<tran:trafficSpace>
						<tran:TrafficSpace gml:id="trk_a06d2e54-9f71-4c48-8b05-4d7e0f3a6b89">
							<core:boundary>
								<tran:TrafficArea gml:id="trk_e9136f4c-5a0d-4eb6-9c84-9f1b2d5a7c30">
									<core:lod1MultiSurface>
