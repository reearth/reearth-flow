...
<!--
  ...
  Placed under udx/rwy so the result files carry the 03-2_鉄道 prefix; otherwise identical to the
  tran:Road fixture next to it.

  A single tran:Railway within saitama-shi mesh 53395499 (EPSG:6697) carrying two LOD1 boundaries:
...
urn:oasis:names:tc:ciq:xal:3 ../../schemas/citygml/xAL/3.0/xAL.xsd">
	...
	<core:cityObjectMember>
		<tran:Railway gml:id="rwy_4a1b7c30-6e9d-4f52-8a04-1b3d5f7a9c26">
			<gml:name>11100-rwy-1</gml:name>
			...
			<tran:section>
				<tran:Section gml:id="rwy_1dd047c4-518d-4faa-9b80-408f28b8a78e">
					<tran:trafficSpace>
						<tran:TrafficSpace gml:id="rwy_5b2c8d41-7f0e-4a63-9b15-2c4e6a8b0d37">
							<core:boundary>
								<tran:TrafficArea gml:id="rwy_6c3d9e52-8a1f-4b74-8c26-3d5f7b9c1e48">
					...
					<tran:auxiliaryTrafficSpace>
						<tran:AuxiliaryTrafficSpace gml:id="rwy_9f6a2b85-1d4c-4e07-9f59-6a8c0e2b4d71">
							<core:boundary>
								<tran:AuxiliaryTrafficArea gml:id="rwy_0a7b3c96-2e5d-4f18-8a6a-7b9d1f3c5e82">
									<core:lod1MultiSurface>
