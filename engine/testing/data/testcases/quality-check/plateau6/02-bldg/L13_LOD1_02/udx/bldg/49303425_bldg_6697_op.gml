...
https://www.geospatial.jp/iur/urc/4.0 ../../schemas/iur/urc/4.0/urbanCore.xsd">
	<gml:boundedBy>
		<gml:Envelope srsName="http://www.opengis.net/def/crs/EPSG/0/6697" srsDimension="3">
			...
			<gml:upperCorner>2.0 2.0 0.0</gml:upperCorner>
		</gml:Envelope>
	</gml:boundedBy>
	<core:cityObjectMember>
		<bldg:Building gml:id="bldg_l13lod1b-0001">
			<gml:name>23201-bldg-L13-LOD1-touching</gml:name>
			...
			<!-- L13 LOD1 check target: the interior ring touches the exterior ring boundary
			     -> one InteriorRingNotContainedInExteriorRing error under
			     "LOD1 境界面のエラー". -->
			<core:lod1Solid>
				<gml:Solid>
					<gml:exterior>
						<gml:CompositeSurface>
							<gml:surfaceMember>
								<gml:Polygon>
									<gml:exterior>
										<gml:LinearRing>
											<gml:posList>0.0 0.0 0.0 2.0 0.0 0.0 0.0 2.0 0.0 0.0 0.0 0.0</gml:posList>
										</gml:LinearRing>
									</gml:exterior>
									<gml:interior>
										<gml:LinearRing>
											<gml:posList>1.0 1.0 0.0 1.0 0.5 0.0 0.0 1.0 0.0 1.0 1.0 0.0</gml:posList>
										</gml:LinearRing>
									</gml:interior>
								</gml:Polygon>
							</gml:surfaceMember>
