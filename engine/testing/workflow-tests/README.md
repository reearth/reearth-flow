...
One can also run tests individually. From the engine's root:
```bash
...
Test cases are located in `testing/data/testcases/`:
```
testing/data/testcases/.../T-BLDG-02/
...
1. Create a new directory under `testing/data/testcases/` in the appropriate category
