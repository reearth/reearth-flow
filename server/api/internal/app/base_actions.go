...
var baseActions = map[string]bool{
	// Input
	"CityGML 2 Reader":    true,
	"CityGML 3 Reader":    true,
	"CSV Reader":          true,
	...
	"XML Validator":           true,
	// PLATEAU
	"PLATEAU4.AttributeFlattener":                      true,
	"PLATEAU4.BuildingInstallationGeometryTypeChecker": true,
	"PLATEAU4.BuildingUsageAttributeValidator":         true,
	"PLATEAU4.CityCodeExtractor":                       true,
	"PLATEAU4.DestinationMeshCodeExtractor":            true,
	"PLATEAU4.DomainOfDefinitionValidator":             true,
	"PLATEAU4.GmlNameCodeSpaceValidator":               true,
	...
	"PLATEAU4.UDXFolderExtractor":                      true,
	"PLATEAU4.UnmatchedXlinkDetector":                  true,
	"PLATEAU6.BuildingUsageAttributeValidator":         true,
	"PLATEAU6.DestinationMeshCodeExtractor":            true,
	"PLATEAU6.DomainOfDefinitionValidator":             true,
	"PLATEAU6.MissingAttributeDetector":                true,
	"PLATEAU6.ObjectListExtractor":                     true,
	"PLATEAU6.SolidIntersectionTestPairCreator":        true,
	"PLATEAU6.TransitiveLinkResolver":                  true,
	"PLATEAU6.TransportationXlinkDetector":             true,
	"PLATEAU6.UDXFolderExtractor":                      true,
	"PLATEAU6.UnmatchedXlinkDetector":                  true,
}
