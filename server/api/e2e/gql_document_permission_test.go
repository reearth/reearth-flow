...
func TestDocumentOperations_DeniedWithoutPermission(t *testing.T) {
	...
	assertDenied(t, e, "projectNamedSnapshot",
		`query($projectId: ID!, $snapshotNumber: Int!) { projectNamedSnapshot(projectId: $projectId, snapshotNumber: $snapshotNumber) { snapshotNumber updates } }`,
