...
use crate::domain::repositories::{KVEntry, KVStore};
use crate::infrastructure::storage::redis::RedisStore;
use crate::infrastructure::tools::{compress_brotli, decompress_brotli};
use anyhow;
    ...
    Error: From<<Self as KVStore>::Error>,
{
    ...
    async fn flush_doc_v2<K: AsRef<[u8]> + ?Sized + Sync>(
        ...
        let compressed_data = compress_brotli(&state)?;
